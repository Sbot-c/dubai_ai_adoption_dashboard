...
with tab3:
    ...
    if not collab_df.empty:
        ...
        # Merge defaults and customize font size for Sankey labels without duplicating keyword arguments
        sankey_layout = plotly_layout_defaults.copy()
        sankey_layout["font"] = dict(family="-apple-system, sans-serif", size=13, color="#1E293B")
