...
def load_data():
    ...
    # Replace NaN/null values with "None" string cleanly
    data = data.fillna("None")
    return data

# INITIALIZE df FIRST BEFORE ANY OTHER CODE USES IT
df = load_data()
...
# Safe Python-native sorting & casting to strings to prevent any numpy/pandas type conflicts
